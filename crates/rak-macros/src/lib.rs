...
/// ```ignore
/// use rak_macros::tool;
/// use rak_core::{ToolContext, Result, ToolResponse};
/// use std::sync::Arc;
///
...
pub fn tool(args: TokenStream, input: TokenStream) -> TokenStream {
    ...
    let output = quote! {
        ...
        #fn_visibility #fn_async fn #fn_name(
            ctx: ::std::sync::Arc<dyn ::rak_core::ToolContext>,
            params: ::serde_json::Value,
        ) -> ::rak_core::Result<::rak_core::ToolResponse> {
            #fn_body
        }

        /// Tool creator function
        #fn_visibility fn #creator_name() -> ::rak_core::Result<::rak_tool::FunctionTool> {
            use ::rak_tool::ToolSchema;

            let schema = ToolSchema::new()
                .property("params", "object", "Tool parameters")
                .build();

            ::rak_tool::FunctionTool::builder()
                .name(#tool_name)
