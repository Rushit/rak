...
fn test_capability_filtering() {
    ...
    assert!(!text_gen_providers.is_empty(), "Should find text generation providers");
    ...
    assert!(!embedding_providers.is_empty(), "Should find embedding providers");
...
fn test_gemini_provider_creation() {
    ...
    // Create provider
    let provider = config.create_provider().expect("Should create Gemini provider");
...
fn test_openai_provider_creation() {
    ...
    // Create provider
    let provider = config.create_provider().expect("Should create OpenAI provider");
...
fn test_provider_by_name() {
    ...
    let gemini = config.create_provider_by_name("gemini").expect("Should create Gemini");
    assert_eq!(gemini.metadata().name, "gemini");
    
    // Create OpenAI provider
    let openai = config.create_provider_by_name("openai").expect("Should create OpenAI");
