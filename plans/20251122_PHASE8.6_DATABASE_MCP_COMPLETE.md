...
### 1. Native Database Tools (`zdk-database-tools`)
...
- **Seamless Integration**: MCP tools work like native ZDK tools
...
│   │   └── tool_wrapper.rs  # MCP-to-ZDK adapter
│   └── Cargo.toml
│
└── zdk-core/
    └── src/
...
1. **zdk-core**: Added `Toolset` trait
2. **zdk-agent**: Enhanced builder and run() method
...
**Problem**: zdk-session used sqlx 0.8, initially used 0.7  
...
- [ZDK Project Scope](./20251119_1410_PROJECT_SCOPE.md)
